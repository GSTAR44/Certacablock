...
Certacablock is a decentralized application (dApp) built on Base/Ethereum and compatible with any chain for issuing and verifying academic certificates on the blockchain.
